####
# First version yolo copy
# Based on pretrained model vvg16
...
class yolonet:
    ...
    def __init__(data,vgg16_weights,sess):
        self.data = data
        self.vgg16model(data,vvg16_weights,sess)
        self.deleteLayers()
        self.addLayers()
    ...
    def addLayers():
        ...
        self.pool_added1 = tf.nn.max_pool(self.conv_added4,
                               ksize=[1, 2, 2, 1],
                               strides=[1, 2, 2, 1],
                               padding='SAME',
                               name='pool_added1')
        ...
        self.pool_added2 = tf.nn.max_pool(self.dropout,
                                ksize=[1, 2, 2, 1],
                                strides=[1, 2, 2, 1],
                                padding='SAME',
                                name='pool_added2')
    ...
    def vgg16model(self, imgs, weights=None, sess=None):
        self.imgs = imgs
        self.convlayers()
        self.fc_layers()
    ...
    def convlayers(self):
        ...
        #NOTE THAT WE NEED TO CHANGE HERE
        # zero-mean input
