...
def defineloss(self, net_out):
    ...
    # TODO
    # meta
    sconf = self.hyperparameters.object_scale
    snoob = self.hyperparameters.noobject_scale
    scoor = self.hyperparameters.coord_scale
    sprob = self.hyperparameters.class_scale
