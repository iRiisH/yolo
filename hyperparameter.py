...
def define_flags():
    ...
    flags.DEFINE_integer ("batch_size", 16, "the size of batches (the number of pictures taken in each training circle)")
    ...
    flags.DEFINE_integer ("epoch", 1000, "numbers of training turns")
